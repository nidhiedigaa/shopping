...
function NewArrivals() {
  ...
  return (
    <section className="py-16 px-4 lg:px-0">
        ...
        <div className={`container mx-auto overflow-x-scroll flex space-x-6 relative ${isDragging?"cursor-grabbing":"cursor-grab"}`} ref={scrollRef} onMouseDown={handleMouseDown}
