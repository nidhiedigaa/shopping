  ...
  return (
   ...
   <input placeholder='Enter your email address' className='w-full p-2 border rounded' type="email" value={email} onChange={(e)=>setEmail(e.target.value)} />
    ...
    <div className='mb-4'>
        ...
        <input className='w-full p-2 border rounded' placeholder='Enter your password' type="password" value={password} onChange={(e)=>setPassword(e.target.value)} />
    </div>
    ...
    <p className='mt-6 text-center text-sm'>
        ...
        <div className='h-full flex flex-col justify-center items-center'>
            <img src={register} alt="login to account" className='h-[750px] w-gull object-cover' />
        </div>
        </div>
    </div>
  )
